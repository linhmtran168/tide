function _tide_init_install --on-event _tide_init_install
    ...
    if status is-interactive
        ...
        if contains linhmtran168/tide (string lower $_fisher_plugins)
            set_color bryellow
            echo "linhmtran168/tide is a development branch. Please install from a release tag:"
            _tide_fish_colorize "fisher install linhmtran168/tide@v6"
            sleep 3
        end
